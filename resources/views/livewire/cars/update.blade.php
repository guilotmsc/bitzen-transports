            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-4">
                        ...
                        @error('manufacturer') <span class="error">A marca é obrigatória</span> @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @error('name') <span class="error">O modelo é obrigatório</span> @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @error('plate') <span class="error">A placa é obrigatória</span> @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @error('year_of_manufacturer') <span class="error">O ano é obrigatório</span> @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @error('tank_capacity') <span class="error">A capacidade é obrigatória</span> @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @error('fuel_type') <span class="error">O tipo de combustível é obrigatório</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="obs" class="block text-gray-700 text-sm font-bold mb-2">Observação:</label>
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="obs" wire:model="obs">
                    </div>

                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                            <button wire:click="update()" type="button" class="inline-flex justify-center w-full rounded-md border border-gray-300 px-4 py-2 bg-gray-200 text-base leading-6 font-medium text-gray-700 shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition ease-in-out duration-150 sm:text-sm sm:leading-5">Salvar</button>
                        </span>
